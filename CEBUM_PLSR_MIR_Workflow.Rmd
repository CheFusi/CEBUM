...
required_packages <- c("writexl","readxl","randomForest", "caret", "pls", "data.table", "ithir", 
                       ...
                       "mixOmics", "yardstick", "purrr", "furrr", "tibble","ranger","VIM","shiny","FNN","lightgbm", "xgboost", "dials", "tune", "brnn", "recipes", "doParallel")
...
calculate_metrics <- function(results_list, data_type, slprptr, .x, model_type) {
  ...
  metrics_list <- map(results_list, function(result) {
    ...
    if (length(truth) != nrow(predictions)) {
      ...
      return(tibble(R_sq = NA, MAE = NA, RMSE = NA, bias = NA))
    }
  ...
  rmse_value <- if (!is.na(response_range) && response_range > 0) rmse_value_plain / (response_range / 10) else NA
    ...
    return(tibble(R_sq = r2_value, RMSE = rmse_value, bias = bias_value, MAE = mae_value))
  })
...
run_all_properties <- function(slprptr, df1, spec_trt, model_type, identifier,
  ...
  all_metrics <- furrr::future_map_dfr(property_range, function(.x) {
    ...
    if (nrow(df.sel) <= 20) {
      ...
      return(tibble(Property = slprptr[.x], Data_Type = "Skipped", Model = model_type, R_sq = NA, MAE = NA, RMSE = NA, bias = NA, ncomp = NA))
    }
  ...
  NULL
   ...
   if (is.null(preprocessed_splits)) {
      return(tibble(Property = slprptr[.x],
                    Data_Type = "Skipped",
                    Model = model_type,
                    R_sq = NA, MAE = NA, RMSE = NA, bias = NA, ncomp = NA))
    }
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier, 
                   use_source = FALSE, tuning_goal = "rmsep", num_bootstrap = 2, property_range = 25)# :39,41:72, 87,102))
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier, 
                   use_source = TRUE, tuning_goal = "rmsep", num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier, 
                   use_source = FALSE, source_name = "Cornell ", tuning_goal = "rmsep", num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt_MIR_lab, model_type = "pls", identifier, 
                   use_source = FALSE, tuning_goal = "rmsep", num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier,
                   use_source = FALSE, tuning_goal = "rmsep", include_pca = TRUE, num_pca_comp =10, num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
identifier <- initialize_workspace("PLSR_RMSEP_MI_totsplit_PCAfeat_variance")  # For RMSEP
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier,
                   use_source = FALSE, tuning_goal = "rmsep", include_pca = TRUE, variance_threshold = 0.95, num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt_NIR, model_type = "pls", identifier, 
                   use_source = FALSE, tuning_goal = "rmsep", num_bootstrap = 50) #, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "rf", identifier,  
                   use_source = FALSE, tuning_goal = "rmsep",
                   num_bootstrap = 50)#, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "rf", identifier,  
                   use_source = FALSE, tuning_goal = "rmsep", include_zv = TRUE, num_bootstrap = 30, property_range =c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
# run_all_properties(slprptr, df1, spec_trt, model_type = "rf", identifier,
#                    use_source = TRUE, tuning_goal = "rmsep", include_zv = TRUE, num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
# run_all_properties(slprptr, df1, spec_trt, model_type = "rf", identifier,
#                    use_source = FALSE, source_name = "Cornell ", tuning_goal = "rmsep", include_zv = TRUE, num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "rf", identifier,  
                   use_source = FALSE, tuning_goal = "rmsep", include_pca = TRUE, num_pca_comp =20, num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "rf", identifier,  
                   use_source = FALSE, tuning_goal = "rmsep", include_pca = TRUE, variance_threshold = 0.99, num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "rf", identifier,
                   use_source = FALSE, tuning_goal = "rmsep", include_pls = TRUE, num_bootstrap = 30, property_range = c(25:39,41:46,48,50,51,53,55,57,65,67,69,71,73,75,77))
```
...
run_all_properties(slprptr, df1, spec_trt_NIR, model_type = "rf", identifier,  
                   use_source = FALSE, tuning_goal = "rmsep",num_bootstrap = 50)#, property_range = 49:51)
```
...
Stop running the separate R processes (in parallel)
