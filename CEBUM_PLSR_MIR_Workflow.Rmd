...
**NOTE: prepare_model_data and preprocess_data functions are a bit redundant ... consider combining once you solidify script**
...
fit_model <- function(model_spec_list, train_data_list, test_data_list, recipe_list, model_type,
  ...
  results_list <- map2(seq_along(train_data_list), train_data_list, function(iter, train_data) {
    ...
    #print(str(test_data_list))
    #print(class(test_data_list))
   
    #print(head(test_data_list[[3]][1:5, 1:5]))
    #print(head(train_data_list[[3]][1:5, 1:5]))
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier, 
                   use_source = FALSE, tuning_goal = "rmsep", num_bootstrap = 300, property_range = c(25:39,41:57,65:77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier, 
                   use_source = TRUE, tuning_goal = "rmsep", num_bootstrap = 300 , property_range = c(25:39,41:57,65:77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier, 
                   use_source = FALSE, source_name = "Cornell ", tuning_goal = "rmsep", num_bootstrap = 300 , property_range = c(25:39,41:57,65:77))
```
...
run_all_properties(slprptr, df1, spec_trt_MIR_lab, model_type = "pls", identifier, 
                   use_source = FALSE, tuning_goal = "rmsep", num_bootstrap = 30 , property_range = c(25:39,41:57,65:77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier,
                   use_source = FALSE, tuning_goal = "rmsep", include_pca = TRUE, num_pca_comp =10, num_bootstrap = 300 , property_range = c(25:39,41:57,65:77))
```
...
run_all_properties(slprptr, df1, spec_trt, model_type = "pls", identifier,
                   use_source = FALSE, tuning_goal = "rmsep", include_pca = TRUE, variance_threshold = 0.95, num_bootstrap = 30 , property_range = c(25:39,41:57,65:77))
```
